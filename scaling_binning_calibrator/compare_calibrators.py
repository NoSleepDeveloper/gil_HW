...
if __name__ == "__main__":
    ...
    cifar10_experiment_marginal(
        probs_path='./data/mnist_probs.dat',
        ce_save_path=prefix + 'mnist_marginal_ce_plot',
        mse_ce_save_path=prefix + 'mnist_marginal_mse_ce_plot')
    # Top-label calibration mnist experiment in the Appendix, 1000 points.
    np.random.seed(0)  # Keep results consistent.
    cifar10_experiment_top(
        probs_path='data/mnist_probs.dat',
        ce_save_path=prefix + 'mnist_top_ce_plot',
        mse_ce_save_path=prefix + 'mnist_top_mse_ce_plot')
